	...
	public static String getAnecdotal(Student s, int whichSubject) {
		...
		case 3: // Science Grade Anecdote
			return "\n\nScience\n\nOur first science unit focused on \"Energy and Electricity\". Through hands-on experiences, "
					...
					+ s.getFirstName() + " worked through the scientific method with minimal support from the teacher. "
		...
		case 4: // Social Studies Grade Anecdote
			return "\n\nSocial Studies\n\nIt has been a pleasure studying social studies with " + s.getFirstName()
					+ " this semester. " + s.getFirstName()
					+ " asks thought provoking questions, and is able to push our thinking in class discussions. "
					+ s.getFirstName()
					+ " is able to do research in order to collect relevant facts on a topic, as well as formulate "
					+ P2 + " own opinion based on the research. Over the course of the year, " + s.getFirstName()
					+ " has grown in " + P2
					+ " ability to think critically about and take a position on an issue, and confidently defend " + P2
					+ " position using facts and figures to support " + P2
					+ " argument.  When considering current and historical events, " + s.getFirstName()
					+ " can read and summarize articles, as well as formulate questions based on the articles. " + P1
					+ " participates actively in our class discussions, where " + P4
					+ " demonstrates a clear and supported opinion with examples from the text.\n\nAs "
					+ s.getFirstName() + " has been studying the Northeast and Southeast regions of the United States "
					+ P4 + " is able to determine similarities and differences between the two regions.  "
					+ "More recently, the students were asked to create a \"character\" persona that they "
					+ "used to determine which region would be more economically advantageous to their character. "
					+ "I look forward to seeing all of the creative learning " + P4
					+ " continues to share during our work with Westward Expansion during the last part of our year.\n\n";
